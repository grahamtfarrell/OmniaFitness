...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/crossfitomnia/",
    icon: (
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@omnia.fit.co",
    icon: (
      <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" aria-hidden>
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/channel/UCzae9poipMx79U0xjwiqg0g",
    icon: (
      <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" aria-hidden>
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/Omnia.fitco",
    icon: (
      <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" aria-hidden>
    ...
    <footer className="bg-black px-6 py-16 text-pink-primary md:py-20">
      <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        >
          ...
          <JoinNewsletterButton className="uppercase tracking-[0.2em] transition-opacity hover:opacity-60 md:tracking-[0.22em]">
            Join newsletter
